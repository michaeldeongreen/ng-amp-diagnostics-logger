...
/**
 * The AppComponent class demonstrates how to use the NgAmpDiagnosticsLoggerService service to send Azure Media Player telemetry information to
 * Application Insights.
 */
export class AppComponent implements AfterViewInit, OnInit {
  title = 'angular-amp-appinsights-demo';
   ...
   * The log method of NgAmpDiagnosticsLoggerService is called and passed the mezzanine id but the value can be any string.
